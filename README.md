...
It connects to Elasticsearch, retrieves alerts generated by a specific detection rule, extracts the attacker’s source IP address, and then creates a firewall rule using UFW to block further SSH access from that IP.
